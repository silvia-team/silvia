...
retrieve_soil_stocks <- function(clc, path_to_aldo_clc){
  ...
  dt_soils_content <- fread(here("data", "aldo", "carbon_content_soil.csv"))
...
retrieve_biomass_stocks_in_forests <- function(dt, path_to_aldo_clc){
  ...
  dt_biomass_forests <- fread(here("data", "aldo", "biomass_forests.csv"))
...
retrieve_biomass_stocks_out_forests <- function(dt, path_to_aldo_clc){
  ...
  dt_biomass_wo_forests <- fread(here("data", "aldo", "biomass_wo_forests.csv"))
...
retrieve_harvested_wood <- function(dt){
  ...
  dt_harvested_wood <- fread(here("data", "aldo",  "harvested_wood.csv"))
